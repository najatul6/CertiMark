                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-2 px-1 flex flex-col justify-center items-center gap-2 text-sm capitalize">
                        <button className="w-full bg-green-600 hover:bg-green-500 rounded-xl text-white">
                          Approve
                        </button>
                        <button className="w-full bg-red-600 hover:bg-red-400 rounded-xl text-white">
                          Reject
                        </button>
                      </td>
                    </tr>
