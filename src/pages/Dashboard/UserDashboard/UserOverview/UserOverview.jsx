  ...
  return (
    <div className="">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-r from-teal to-green-600 shadow rounded-lg p-10">
        ...
        <div className="bg-gradient-to-r from-blue-400 to-indigo-600 shadow rounded-lg p-10">
          <h3 className="font-semibold text-darkGreen text-xl pb-5">
            Verified Certificates
          </h3>
        ...
        <div className="bg-gradient-to-r from-red-400 to-red-700 shadow rounded-lg p-10">
          <h3 className="font-semibold text-darkGreen text-xl pb-5">
            Rejected Certificates
          </h3>
          <p className="text-white text-lg pl-4">
        ...
        {/* Total Paid */}
        <div className="bg-gradient-to-r from-purple-500 to-purple-700 shadow rounded-lg p-10">
          <h3 className="font-semibold text-darkGreen text-xl pb-5">
            Total Paid
          </h3>
        ...
        {/* Total Due */}
        <div className="bg-gradient-to-r from-yellow-500 to-orange-500 shadow rounded-lg p-10">
          <h3 className="font-semibold text-darkGreen text-xl pb-5">
            Total Due
          </h3>
