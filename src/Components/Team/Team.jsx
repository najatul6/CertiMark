...
const Team = () => {
  return (
    <div className="py-16 bg-teal font-montserrat">
      ...
      <div>
        <div className="lg:max-w-6xl max-w-xl mx-auto p-4">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 max-md:justify-center mt-12">
            {
                teams?.map(team=><div key={team?._id} className="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                    <img
